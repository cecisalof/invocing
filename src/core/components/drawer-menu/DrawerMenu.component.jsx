...
export const DrawerMenuComponent = ({user}) => {
  ...
  const links = [
    ...
    },
    {
      ...
      childrens: [
        {
          path: '/outcome/suppliers',
          label: 'Proovedores',
          exact: 'false'
        },
        {
          path: '/outcome/invoices-to-pay',
          label: 'Facturas',
          exact: 'false'
        },
        {
          path: '/outcome/expense-tickets',
          label: 'Tickets de Gastos',
          exact: 'false'
        }
      ]
    },
  ...
  const renderNavMenu = (links) => {
    return links.map(({ path, label, childrens, exact, icon, labelHeader }) => (
      <ul>
        {childrens &&
              ...
              <div className="accordion-item">
                <h2 className="accordion-header">
                  <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne">
                    <img className="menuIcon" src={cashIcon} alt="" />
                    {labelHeader}
                  </button>
                </h2>
